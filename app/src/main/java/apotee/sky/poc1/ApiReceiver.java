...
import apotee.sky.poc1.commands.CommandAppRiskReport;
import apotee.sky.poc1.commands.CommandDiscovery;
import apotee.sky.poc1.commands.CommandCamera;
import apotee.sky.poc1.commands.CommandDeviceDump;
import apotee.sky.poc1.commands.CommandDialog;
import apotee.sky.poc1.commands.CommandGetContacts;
import apotee.sky.poc1.commands.CommandMicrophoneRecorder;
import apotee.sky.poc1.commands.CommandProcessTools;
import apotee.sky.poc1.commands.CommandRunSystem;
import apotee.sky.poc1.commands.CommandSmali;
import apotee.sky.poc1.commands.CommandTelephony;
import apotee.sky.poc1.commands.CommandTorch;
import apotee.sky.poc1.commands.CommandUploadFile;
import apotee.sky.poc1.commands.CommandVibrate;
import apotee.sky.poc1.commands.CommandVolume;
...
// am broadcast --user 0 -n apotee.sky.poc1/.AdbshellkitApiReceiver \
...
// adb -d shell pm grant apotee.sky.poc1 ...
...
public class ApiReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        try {
            // Check if it's a broadcast first. Log for now.
            PowerManager mPm =(PowerManager) context.getSystemService(Context.POWER_SERVICE);
            Logger.debug(intent.toString());
            Logger.debug("PowerManager: isScreenOn=" + mPm.isScreenOn() + " isInterActive=" + mPm.isInteractive());
