...
public class App extends Application {
    ...
    public static final String FILES_PATH = "/data/data/apotee.sky.poc1/files";
    public static final String APP_NAME = "Apotee Sky Poc1";
    ...
    public synchronized void onCreate() {
        ...
        System.setProperty("tinylog.directory", FILES_PATH + "/logs");
    ...
    public static final class DebugTree extends Timber.DebugTree {
        ...
        protected String createStackElementTag(StackTraceElement element) {
            return String.format("apotee.sky.poc1 [C:%s] [M:%s] [L:%s] ",
