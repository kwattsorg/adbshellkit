...
public class CommandTextToSpeech {
    ...
    public static String CMD = "cmd_text_to_speech";
    public static String[] PERMISSIONS = {};

    public static void onReceive(final Context context, Intent intent) {
        context.startService(new Intent(context, android.speech.tts.TextToSpeechService.class).putExtras(intent.getExtras()));
    }
        ...
        protected void onHandleIntent(final Intent intent) {
            ...
            mTts = new TextToSpeech(this, status -> {
                if (status == TextToSpeech.SUCCESS) {
                    ...
                    Timber.e("Failed tts initialization: status=" + status);
                    stopSelf();
                }
            }, speechEngine);
                    ...
                    try {
                        try {
                            if (!mTtsLatch.await(10, TimeUnit.SECONDS)) {
                                Timber.e("Timeout waiting for TTS initialization");
                                return;
                            }
                        } catch (InterruptedException e) {
                            Timber.e("Interrupted awaiting TTS initialization");
                            return;
                        }
                        ...
                        mTts.setOnUtteranceProgressListener(new UtteranceProgressListener() {
                            ...
                            public void onError(String utteranceId) {
                                Timber.e("UtteranceProgressListener.onError() called");
                        ...
                        if (speechLanguage != null) {
                            ...
                            if (setLanguageResult != TextToSpeech.LANG_AVAILABLE) {
                                Timber.e("tts.setLanguage('" + speechLanguage + "') returned " + setLanguageResult);
                            }
                        }
