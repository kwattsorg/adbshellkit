...
public class Logcat extends Thread implements Cloneable {
  ...
  private boolean runAsSuperUser = false;
  ...
  @Override public void run() {
    super.run();
    try {
      //Log.d("ADB", "this runassuperuser is:" + this.runAsSuperUser);
      String cmd = "logcat -b all -v time";
      if (runAsSuperUser) {
  ...
  @Override public Object clone() {
    Logcat l = new Logcat();
    l.setRunAsSuperUser(this.runAsSuperUser);
    return l;
  }
