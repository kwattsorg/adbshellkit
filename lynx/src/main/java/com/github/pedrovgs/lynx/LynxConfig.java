...
public class LynxConfig implements Serializable, Cloneable {
  ...
  public LynxConfig setRunAsSuperUser(boolean runAsSuperUser) {
  ...
  public boolean getRunAsSuperUser() { return runAsSuperUser;}
  ...
  @Override public boolean equals(Object o) {
    ...
    if (runAsSuperUser != that.runAsSuperUser) return false;
  ...
  @Override public Object clone() {
    return new LynxConfig().setMaxNumberOfTracesToShow(getMaxNumberOfTracesToShow())
        ...
        .setRunAsSuperUser(runAsSuperUser);
  }
